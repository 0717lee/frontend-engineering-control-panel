            ...
            <div className="grid-2">
                ...
                <div className="glass-card">
                    ...
                    <div className="project-meta">
                        ...
                        <div className="project-meta-item" style={{ marginTop: 'var(--spacing-sm)' }}>
                            ...
                            />
                            <span style={{ color: 'var(--color-text-muted)', fontSize: '0.875rem', marginLeft: '4px' }}>{t('settings.seconds', language)}</span>
                        </div>
                        {intervalError && (
